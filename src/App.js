...
const App = () => {
    ...
    //add to dark mode and light mode css

    const [theme, setTheme] = useState('light')
    const btnStyle = {background: theme ===  'dark' ? '#292828' : '#f0f0f0'}
    ...
    const presentage = (e) =>{
        setResult(result.devide(result/100))
    }
    ...
    return (
        <>
            ...
            <div style={btnStyle} className="container">
              
              <form>
                  <input style={btnStyle} type="text" value={result} />
              </form>
              <hr />

              <div style={btnStyle} className="keypad">
